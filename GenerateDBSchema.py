...
class GenerateDBSchema:
    ...
    def generate(self):
        ...
        if file_path:
            ...
            messagebox.showinfo("Info", f"The database schema has been generated and saved to a file {file_path}.")
        else:
            messagebox.showerror("Error", "Failed to generate database schema")
